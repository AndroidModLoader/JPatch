    ...
    if(cfg->GetBool("BuffStaticShadowsCount", true, "Gameplay"))
    {
        ...
        aml->WriteAddr(pGTASA + 0x677BEC, (uintptr_t)asShadowsStored_NEW);
        aml->WriteAddr(pGTASA + 0x6798EC, (uintptr_t)aStaticShadows_NEW);
    ...
    *(float*)(pGTASA + 0x3C51F0) = cfg->GetFloat("MinimalCameraZoomingFOV", 70.0f, "Gameplay");
    ...
    {
        aml->Write(pGTASA + 0x2EC752, "\xA5\xF6\xFA\xEC", 4);
        aml->Write(pGTASA + 0x2EC898, "\xA5\xF6\x56\xEC", 4);
        aml->Write(pGTASA + 0x2EC936, "\xA5\xF6\x08\xEC", 4);
    ...
    {
        aml->WriteFloat(pGTASA + 0x420DF0, 0.001f);
    }

    // Allowes gang wars to have a wanted level (like on PC)
    if(cfg->GetBool("AllowGangWarsWantedLvl", true, "Gameplay"))
    {
        aml->PlaceNOP4(pGTASA + 0x3F921E, 1);
        aml->PlaceNOP4(pGTASA + 0x3F922C, 1);
        aml->PlaceNOP4(pGTASA + 0x3F92F2, 1);
    ...
    if(cfg->GetBool("FixPlayerAimingTasks", true, "Gameplay"))
    {
        ...
        aml->PlaceNOP(pGTASA + 0x3504EA, 1);
        aml->PlaceNOP(pGTASA + 0x4CA170, 1);
        aml->PlaceNOP(pGTASA + 0x4C61CA, 1);
    }
    ...
    {
        AIAccuracyAfterVehicle_BackTo_Next = pGTASA + 0x5DF786 + 0x1;
        AIAccuracyAfterVehicle_BackTo_Continue = pGTASA + 0x5DF7E2 + 0x1;
